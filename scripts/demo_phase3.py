...
logger = logging.getLogger("PulseGraph.DemoPhase3")
...
def main():
    logger.info("=== Starting PulseGraph AI Phase 3 Demonstration Script ===")
    ...
    print("\n" + "="*70)
    print("      PULSEGRAPH AI CLINICAL DECISION SUPPORT - DEMO EXECUTION")
    print("="*70)
